...
import { bgColor, borderRadius } from 'styles';
...
export default class VideoPlayer extends Component {
  ...
  constructor(props) {
    ...
    this.methods = {
      ...
      toggleMuted: this._toggleMuted.bind(this)
    };
  ...
  goBackwardHandler(time = 15) {
    let state = this.state;
    state.currentTime =
      this.state.currentTime > time ? this.state.currentTime - time : 0;
    this.player.ref.seek(state.currentTime);
    this.setState(state);
  }

  goForwardHandler(time = 15) {
    let state = this.state;
    state.currentTime =
      this.state.currentTime + time < this.state.duration
  ...
  renderTopControls() {
    return (
      ...
      >
        <View style={[t.flexRow, t.pY3, t.justifyBetween, t.alignCenter]}>
          <View
            style={[
              t.flexRow,
              borderRadius(16),
              bgColor(colors.codGray900),
              t.alignCenter
            ]}
          >
            <TouchableOpacity
              ...
              customStyle={[t.pX4, t.pY3]}
            >
              <Image
                source={require('assets/icClose.png')}
                style={[t.w5, t.h5]}
                resizeMode="contain"
              />
            </TouchableOpacity>
            {!this.props.disableFullScreen && (
              ...
              >
                <Image
                  source={require('assets/icFullScreen.png')}
                  style={[t.w6, t.h5]}
                  resizeMode="contain"
                />
              </TouchableOpacity>
            ...
            {!this.props.disableZoom && (
              <TouchableOpacity style={[t.pX4, t.pY3]}>
                <Image
                  source={require('assets/icZoom.png')}
                  style={[t.w6, t.h5]}
                  resizeMode="contain"
                />
              </TouchableOpacity>
          ...
          <View style={[borderRadius(16), bgColor(colors.codGray900)]}>
            <TouchableOpacity
              onPress={() => {
                this.methods.toggleMuted();
              }}
              customStyle={[t.pX4, t.pY3]}
            >
              {this.state.muted ? (
                <Image
                  source={require('assets/icMute.png')}
                  style={[t.w6, t.h5]}
                  resizeMode="contain"
                />
              ) : (
                <Image
                  source={require('assets/icVolumn.png')}
                  style={[t.w6, t.h5]}
                  resizeMode="contain"
                />
              )}
    ...
    return (
      <View style={t.flexRow}>
        <TouchableOpacity
          onPress={() => {
            this.resetControlTimeout();
            this.goBackwardHandler(15);
          }}
        >
          <Image
            style={[t.w5, t.h5, t.mX5]}
            source={require('assets/icGoBackward15.png')}
            resizeMode="contain"
          />
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          {this.state.paused === true ? (
            <Image
              style={[t.w5, t.h6, t.mX5]}
              source={require('assets/icPlay.png')}
              resizeMode="contain"
            />
          ) : (
            <Image
              style={[t.w5, t.h6, t.mX5]}
              resizeMode="contain"
              source={require('assets/icPause.png')}
            />
          )}
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => {
            this.resetControlTimeout();
            this.goForwardHandler(15);
          }}
        >
          <Image
            style={[t.w5, t.h5, t.mX5]}
            source={require('assets/icGoForward15.png')}
            resizeMode="contain"
          />
        </TouchableOpacity>
      </View>
  ...
  renderTimer() {
    return (
      <View style={[t.flexRow, t.justifyBetween, t.w11_12]}>
        <Text style={t.textWhite}>
          {this.formatTime(this.state.currentTime)}
        </Text>
        <Text style={t.textWhite}>{this.formatTime(this.state.duration)}</Text>
      </View>
    );
  }
    ...
    if (this.state.loading) {
      return (
        <View style={styles.loader.container}>
          <Animated.Image
            source={require('assets/icLoader.png')}
            style={[
              styles.loader.icon,
              {
                transform: [
    ...
    if (this.state.error) {
      return (
        <View style={styles.error.container}>
          <Image
            source={require('assets/icError.png')}
